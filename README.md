...
- <img src="https://github.com/user-attachments/assets/22854bc5-e05a-465d-9324-7986adb9e8cc" width="500">
...
- sLLM을 사용하여 보안혹은 인터넷 사용환경이 제한된 곳에서도 사용가능한 방법 탐색
- 자연어로 비교 질문시 시각화 혹은 쿼리문 생성에 대한 정확도 향상
- 나온 데이터를 기반으로 분류 혹은 회귀까지 LLM을 통하여 향후 미래에 대한 인사이트 도출 시도
